...
#include <opencv4/opencv2/core.hpp>      // Basic OpenCV structures
#include <opencv4/opencv2/core/utility.hpp>
#include <opencv4/opencv2/imgproc.hpp>// Image processing methods for the CPU
#include <opencv4/opencv2/imgcodecs.hpp>// Read images
